<template>
  <div id="app">
    <header>
      <div class="header-content">
        ...
        <nav class="main-nav">
          ...
          <button @click="currentView = 'classes'" :class="{ 'active': currentView === 'classes' }">Classes Editor</button>
    ...
    <main v-else-if="currentView === 'classes'">
      <ClassesEditor 
        :classes-data="classesData"
        @update-classes="data => classesData = data"
        @back="currentView = 'dashboard'" 
      />
    </main>
    ...
    <main v-else-if="currentView === 'avoids'">
      <AvoidsEditor 
        ...
        :students-data="studentsData"
        @update-avoids="data => avoidsData = data"
        @back="currentView = 'dashboard'" 
      />
    </main>
